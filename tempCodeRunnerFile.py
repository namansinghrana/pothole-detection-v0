...
from alert_system import play_alert
...
threshold_value = st.sidebar.slider("Threshold Value", 100, 255, 150)
min_area = st.sidebar.slider("Min Pothole Area", 500, 5000, 1000)
...
def process_video(video_path):
    ...
    while cap.isOpened():
        ...
        processed_frame, potholes = detect_potholes(
            frame, threshold_value, min_area, sensitivity
        )
